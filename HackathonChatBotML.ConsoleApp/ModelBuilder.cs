...
namespace HackathonChatBotML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\DENGR\source\repos\HackathonChatBot\HackathonChatBot.UI\LearningData.csv";
        private static string MODEL_FILEPATH = @"C:\Users\DENGR\AppData\Local\Temp\MLVSTools\HackathonChatBotML\HackathonChatBotML.Model\MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Conversion.MapValueToKey("Category", "Category")
                                      .Append(mlContext.Transforms.Text.FeaturizeText("Question_tf", "Question"))
                                      .Append(mlContext.Transforms.CopyColumns("Features", "Question_tf"));
